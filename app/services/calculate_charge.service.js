...
class CalculateChargeService {
  ...
  static async go (payload, regime, presenterResponse = true) {
    ...
    // translated to things we understand. So we use this option to allow us to return early with that result, adding
    // the financial year generated by CalculateChargeTranslator.
